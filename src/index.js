const cards = [
  ...
  },
  {
    ...
    intro: 'EMPTY',
    text: 'A nice and easy to use todo list application. You can add, delete, edit and mark tasks as done. Never forget to do your tasks!',
    img: 'img2',
    src: 'assets/todo_app.png',
    tech: ['html', 'Js', 'Webpack', 'Jest'],
    links: {
      live: "'https://nice-todolist.netlify.app/'",
      source: "'https://github.com/mrEckendonk/todo-list-v1'",
    },
  },
  {
...
const menuHamburgerBtn = document.querySelector('#mobile');
